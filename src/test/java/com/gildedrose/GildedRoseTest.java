...
class GildedRoseTest {
    ...
    @Test
    void backstage_passes_increase_in_quality_by_1_when_there_are_more_than_10_days() {
    ...
    @Test
    void conjured_item_degrades_in_quality_twice() {
        Item item = new Item("Conjured item", 3, 20);
        GildedRose subject = new GildedRose(new Item[]{item});
    ...
    @Test
    void conjured_item_degrades_in_quality_by_four() {
        Item item = new Item("Conjured item", 0, 20);
        GildedRose subject = new GildedRose(new Item[]{item});
    ...
    @Test
    void conjured_item_can_not_be_negative() {
        Item item = new Item("Conjured item", 0, 2);
        GildedRose subject = new GildedRose(new Item[]{item});
